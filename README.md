...
This repository supports an MSc IRP on tidal disruption during close encounters with Mars. It contains:

- FoF outcome extraction scripts for HDF5 simulation outputs
- before-extraction and after-extraction EDA workflows
- a baseline ML pipeline for FoF-derived fragment statistics
