...
Run:
    python eda/outcome_analysis/eda_bound_mass_by_params.py \
      --outcomes outputs/bound_outcomes.csv \
      --eda-dir eda/outcome_analysis
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--eda-dir",  default=str(Path(__file__).resolve().parent))
    return p.parse_args()


def main() -> None:
    args = parse_args()
    plots_dir = Path(args.eda_dir)
