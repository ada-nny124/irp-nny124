#!/usr/bin/env python3
"""Make a clean regime-dependent local-importance figure with matplotlib.

The figure is intentionally restricted to the best-covered matched subset:

- mass fixed to A2000
- resolution fixed to n65
- timestep fixed to 90000
- FoF fixed to 0.004
- one common spin trio: no spin, 3h z, 4.7h z

The figure contains two local spread tests:

- spin spread with velocity families shown separately
- velocity spread with spin states shown separately
"""
