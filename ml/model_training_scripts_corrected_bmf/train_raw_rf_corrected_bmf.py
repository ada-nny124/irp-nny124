...
MODEL_PATH = ARTIFACT_ROOT / "raw_rf" / "main_bmf_raw_rf.pkl"
RF_PARAMS = {
    "n_estimators": 500,
    "max_features": 0.8,
    "min_samples_leaf": 2,
...
def main() -> None:
    ...
    result = train_and_save_regression_model(
        ...
        params=RF_PARAMS,
        bundle_name="main_bmf_raw_random_forest_corrected_bmf",
        extra_bundle_fields={"raw_feature_columns": RAW_FEATURE_COLUMNS},
    )
