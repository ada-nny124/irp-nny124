#!/usr/bin/env python3
"""Train the tuned raw-feature Gradient Boosting BMF model."""
...
ARTIFACT_DIR = Path("ml/trainingartifacts_corrected_bmf/tuned_gradient_boosting")
MODEL_PATH = ARTIFACT_DIR / "main_bmf_tuned_gradient_boosting.pkl"
FOLDS_PATH = ARTIFACT_DIR / "grouped_cv_fold_assignments.csv"
OOF_PATH = ARTIFACT_DIR / "main_bmf_tuned_gradient_boosting_oof_predictions.csv"
METRICS_PATH = ARTIFACT_DIR / "main_bmf_tuned_gradient_boosting_metrics.json"
...
def main() -> None:
    ...
    bundle = {
        "model_name": "main_bmf_tuned_gradient_boosting",
