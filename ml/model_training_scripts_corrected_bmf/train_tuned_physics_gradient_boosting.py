#!/usr/bin/env python3
"""Train the tuned physics-feature Gradient Boosting BMF model."""
...
DATASET_PATH = Path("extraction-outputs_corrected_bmf/tables/bound_outcomes.csv")
ARTIFACT_DIR = Path("ml/trainingartifacts_corrected_bmf/tuned_physics_gradient_boosting")
MODEL_PATH = ARTIFACT_DIR / "main_bmf_tuned_physics_gradient_boosting.pkl"
FOLDS_PATH = ARTIFACT_DIR / "grouped_cv_fold_assignments.csv"
OOF_PATH = ARTIFACT_DIR / "main_bmf_tuned_physics_gradient_boosting_oof_predictions.csv"
METRICS_PATH = ARTIFACT_DIR / "main_bmf_tuned_physics_gradient_boosting_metrics.json"
...
def main() -> None:
    ...
    bundle = {
        "model_name": "main_bmf_tuned_physics_gradient_boosting",
