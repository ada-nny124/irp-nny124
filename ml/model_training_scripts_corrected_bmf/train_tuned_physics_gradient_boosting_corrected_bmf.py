...
MODEL_PATH = ARTIFACT_ROOT / "tuned_physics_gradient_boosting" / "main_bmf_tuned_physics_gradient_boosting.pkl"
...
def main() -> None:
    ...
    result = train_and_save_regression_model(
        ...
        params=GB_PARAMS,
        bundle_name="main_bmf_tuned_physics_gradient_boosting_corrected_bmf",
        extra_bundle_fields={
