...
DEFAULT_TABLES_DIR = SCRIPT_DIR.parent / "tables_corrected_bmf"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--fof-outcomes",
        default="extraction-outputs_corrected_bmf/tables/fof_outcomes.csv",
        help="Path to fof_outcomes.csv",
    )
    parser.add_argument(
        "--bound-outcomes",
        default="extraction-outputs_corrected_bmf/tables/bound_outcomes.csv",
...
python eda/eccentricity_analysis/eda_eccentricity.py \
  --fof-outcomes extraction-outputs_corrected_bmf/tables/fof_outcomes.csv \
  --bound-outcomes extraction-outputs_corrected_bmf/tables/bound_outcomes.csv \
