...
def main() -> None:
    ...
    module = load_module("figure3_build_corrected_bmf_runtime", FIGURES_DIR / "figure3_build.py")
    module.DATASET_PATH = CORRECTED_BOUND
    module.OUTPUT_PATH = OUTPUT_FIGURES / "figure3_used_in_report_corrected_bmf.png"
