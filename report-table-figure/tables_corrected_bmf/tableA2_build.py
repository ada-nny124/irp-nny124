...
OUTPUT_PATH = ROOT / "report-table-figure" / "tables_corrected_bmf" / "tableA2_used_in_report.csv"

MODEL_SPECS = [
    ("Gradient Boosting", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "gradient_boosting" / "main_bmf_gradient_boosting_metrics.json"),
    ("Tuned Gradient Boosting", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "tuned_gradient_boosting" / "main_bmf_tuned_gradient_boosting_metrics.json"),
    ("Random Forest", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "raw_rf" / "main_bmf_raw_rf_metrics.json"),
    ("Tuned RF", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "tuned_rf" / "main_bmf_tuned_rf_metrics.json"),
    ("RF + derived features", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "physics_rf" / "main_bmf_physics_rf_metrics.json"),
    ("GB + derived features", ROOT / "ml" / "trainingartifacts_corrected_bmf" / "tuned_physics_gradient_boosting" / "main_bmf_tuned_physics_gradient_boosting_metrics.json"),
